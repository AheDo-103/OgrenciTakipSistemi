...
using AhdYazilim.OgrenciTakip.UI.Win.UserControls.UserControl.TahakkukEditFormTable;
...
using System.Linq;
using GeneralFunctions = AhdYazilim.OgrenciTakip.UI.Win.Functions.GeneralFunctions;
...
namespace AhdYazilim.OgrenciTakip.UI.Win.Forms.Tahakkuk_Forms
{
    public partial class TahakkukEditForm : BaseEditForm
    {
        ...
        public TahakkukEditForm()
        {
            ...
            DataLayoutControls = new MyDataLayoutControl[] { DataLayoutGenel, DataLayoutGenelBilgiler };
        ...
        protected override void BagliTabloYukle()
        {
            bool TableValueChanged(BaseTablo tablo)
            {
                ...
                // Hoca bunu sonradan izah edicek.
            }
            ...
            if (TableValueChanged(hizmetBilgileriTable))
                GeneralFunctions.YuklenenTablodakiRowaYenidenFocuslan(hizmetBilgileriTable);

            if (TableValueChanged(indirimBilgileriTable))
                GeneralFunctions.YuklenenTablodakiRowaYenidenFocuslan(indirimBilgileriTable);

            if (TableValueChanged(odemeBilgileriTable))
                GeneralFunctions.YuklenenTablodakiRowaYenidenFocuslan(odemeBilgileriTable);

            if (TableValueChanged(geriOdemeBilgileriTable))
                GeneralFunctions.YuklenenTablodakiRowaYenidenFocuslan(geriOdemeBilgileriTable);
        ...
        protected override void NesneyiKontrollereBagla()
        {
            ...
            txtSoyadi.Text = IslemTuru == IslemTuru.EntityInsert ? _ogrenci.Soyadi : entity.Soyad;
            ...
            txtDurum.Text = entity.Durum ? IptalDurum.DevamEdiyor.ToName() : IptalDurum.IptalEdildi.ToName();

            txtKod.Text = entity.Kod;
            txtOkulNo.Text = entity.OkulNo;
            txtKayitTarihi.DateTime = entity.KayitTarihi.Date;
            txtKayitSekli.SelectedItem = entity.KayitSekli.ToName();
            txtKayitDurumu.SelectedItem = entity.KayitDurum.ToName();
            ...
            txtRehberOgretmen.Id = entity.RehberId;
            txtRehberOgretmen.Text = entity.RehberAdi;
            txtSonrakiDonemKayitDurumu.SelectedItem = entity.SonrakiDonemKayitDurumu.ToName();
            txtSonrakiDonemKayitBilgileriAciklama.Text = entity.SonrakiDonemKayitDurumuAciklama;
        ...
        protected override void GuncelNesneOlustur()
        {
            CurrentEntity = new Tahakkuk
            {
                Id = Id,
                Kod = txtKod.Text,
                OgrenciId = IslemTuru == IslemTuru.EntityInsert ? _ogrenci.Id : ((Tahakkuk)OldEntity).OgrenciId,
                OkulNo = txtOkulNo.Text,
                KayitTarihi = txtKayitTarihi.DateTime.Date,
                KayitSekli = txtKayitSekli.Text.GetEnum<KayitSekli>(),
                KayitDurum = txtKayitDurumu.Text.GetEnum<KayitDurumu>(),
                ...
                RehberId = txtRehberOgretmen.Id,
                SonrakiDonemKayitDurumu = txtSonrakiDonemKayitDurumu.Text.GetEnum<SonrakiDonemKayitDurumu>(),
                SonrakiDonemKayitDurumuAciklama = txtSonrakiDonemKayitBilgileriAciklama.Text,
                OzelKod1Id = txtOzelKod1.Id,
                OzelKod2Id = txtOzelKod2.Id,
                OzelKod3Id = txtOzelKod3.Id,
                OzelKod4Id = txtOzelKod4.Id,
                OzelKod5Id = txtOzelKod5.Id,
                Durum = txtDurum.Text.GetEnum<IptalDurum>() == IptalDurum.DevamEdiyor ? true : false,
        ...
        protected override bool BagliTabloHataliGirisKontrol()
        {
            ...
            {
                tabGercekAlt.SelectedPage = pageHizmetBilgileri;
            ...
            {
                tabGercekAlt.SelectedPage = pageOdemeBilgileri;
            ...
            {
                tabGercekAlt.SelectedPage = pageGeriOdemeler;
        ...
        protected override void SecimYap(object sender)
        {
            ...
            using (var sec = new SelectFunctions())
                ...
                else if (sender == txtRehberOgretmen)
                    sec.Sec(txtRehberOgretmen);
        ...
        protected internal override void ButonEnabledDurumu()
        {
            ...
            else if (!FarkliSubeIslemi) // ehe
                GeneralFunctions.ButonEnabledDurumu(btnYeni, btnKaydet, btnGeriAl, btnSil, OldEntity, CurrentEntity, TableValueChanged());
        }
        ...
        {
            var hizmetBilgileriToplami = hizmetBilgileriTable.Tablo.DataController.ListSource.Cast<HizmetBilgileriL>().Where(x => !x.Delete && !x.IptalEdildi).Sum(x => x.BrutUcret - x.KistDonemDusulenUcret);
            var indirimBilgileriToplami = indirimBilgileriTable.Tablo.DataController.ListSource.Cast<IndirimBilgileriL>().Where(x => !x.Delete && !x.IptalEdildi).Sum(x => (x.BrutIndirim - x.KistDonemDusulenIndirim));
            var netHizmetBilgileriToplami = hizmetBilgileriToplami - indirimBilgileriToplami;
            ...
            txtNetHizmetBilgileri.Value = netHizmetBilgileriToplami;
        ...
        private bool DurumKontrol()
        {
            ...
            if (!source.Any(x => !x.Delete && !x.IptalEdildi && x.HizmetTipi == HizmetTipi.Egitim))
            {
                ...
                txtDurum.Text = IptalDurum.IptalEdildi.ToName();
            }
            else
                txtDurum.Text = IptalDurum.DevamEdiyor.ToName();
        ...
        protected override void Yazdir()
        {
            ...
            {
                _iletisimBilgileriTable = new IletisimBilgiTable().AddTable(this);
        ...
        protected override void Control_SelectedPageChanged(object sender, SelectedPageChangedEventArgs e)
        {
            ...
            else if (e.Page == pageEvrakPromosyonBilgileri)
            {
                if (layoutControlEvrakPromosyonBilgileri.Items.Count == 0)
                {
                    ...
                    _promosyonBilgileriTable = new PromosyonBilgiTable().AddTable(this);

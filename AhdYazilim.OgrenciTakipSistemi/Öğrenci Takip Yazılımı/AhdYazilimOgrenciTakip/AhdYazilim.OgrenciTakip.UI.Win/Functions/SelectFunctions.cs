...
using AhdYazilim.OgrenciTakip.UI.Win.Forms.OzelKodForms;
...
namespace AhdYazilim.OgrenciTakip.UI.Win.Functions
{
    public class SelectFunctions : IDisposable
    {
        ...
        private BankaHesapTuru _bankaHesapTuru;
        ...
        public void Sec(MyButtonEdit btnEdit, KartTuru kartTuru, BankaHesapTuru bankaHesapTuru)
        {
            _btnEdit = btnEdit;
            _kartTuru = kartTuru;
            _bankaHesapTuru = bankaHesapTuru;
            SecimYap();
        }
        ...
        private void SecimYap()
        {
            switch (_btnEdit.Name)
            {
                ...
                case "txtYabanciDil":
                    {
                        var entity = (YabanciDil)ShowListForms<YabanciDilListForm>.ShowDialogListForm(KartTuru.Sinif, _btnEdit.Id);
                        if (entity != null)
                        {
                            _btnEdit.Id = entity.Id;
                ...
                case "txtHesap":
                    {
                        switch (_kartTuru)
                        {
                            ...
                            case KartTuru.BankaHesap:
                                {
                                    var entity = (BankaHesapL)ShowListForms<BankaHesapListForm>.ShowDialogListForm(KartTuru.BankaHesap, _btnEdit.Id, _bankaHesapTuru);
                                    if (entity != null)
                                    {
                                        _btnEdit.Id = entity.Id;
                                        _btnEdit.EditValue = entity.HesapAdi;
                            ...
                            //    }
                            //    break;
                            // Henüz SubeListForm ve SubeEditForm yapılmadığı için pasif duruma aldık.
                        }
                    }
                    break;
            }

...
namespace AhdYazilim.OgrenciTakip.UI.Win.Functions
{
    public class SelectRowFunctions
    {
        ...
        private void AddEvents(GridView tablo)
        {
            ...
            _column.VisibleIndex = 0; // Sonrasinde VisibleIndex propertysini, Visible propertysinin önüne çek ve sonuca bak.
        ...
        {
            /*  EHE EHE wow uwu lna kod wu eher a s d f g  */
            _tablo.OptionsView.ShowAutoFilterRow = false;
